...
const LogInFail = () => {
  ...
  return (
    <View style={styles.logInFail}>
      <View style={styles.logInFailChild} />
      <Text style={styles.text}>{`<`}</Text>
      <Text
        style={[styles.loginIntoYour, styles.logInTypo]}
      >{`Login into your account
`}</Text>
      <View style={[styles.logInFailItem, styles.logLayout]} />
      <Text
        style={[styles.chiragsainigmailcom, styles.text1Typo]}
      >{`chiragsaini@gmail.com
`}</Text>
      <View style={[styles.logInFailInner, styles.logLayout]} />
...
`}</Text>
      ...
      />
      <Text style={[styles.forgetPassword, styles.needHelpTypo]}>
        Forget password ?
      </Text>
